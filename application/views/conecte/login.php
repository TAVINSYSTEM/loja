...
<body>
    <div id="loginbox">
        <form class="form-vertical" id="formLogin" method="post" action="<?php echo site_url() ?>/mine/login">
            ...
            <div class="form-actions" style="text-align: center">
                <button class="btn btn-info btn-large" /> Entrar</button>
    ...
    <!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Sistema de Vendas e Ordens de Serviços  </br> <a href="" target="_blank"> Eds-System </a> - Todos os direitos reservados </div>
</div>
<!--end-Footer-part-->
</body>
